...
# Encoder PMOD
set_property PACKAGE_PIN G3 [get_ports enc_swt]						
	set_property IOSTANDARD LVCMOS33 [get_ports enc_swt]
set_property PACKAGE_PIN H2 [get_ports enc_btn]      
 set_property IOSTANDARD LVCMOS33 [get_ports enc_btn]
set_property PACKAGE_PIN K2 [get_ports enc_B]                        
     set_property IOSTANDARD LVCMOS33 [get_ports enc_B]
set_property PACKAGE_PIN H1 [get_ports enc_A]      
